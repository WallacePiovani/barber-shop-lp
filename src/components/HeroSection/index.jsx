...
const HeroSection = () => {
    return (
        <section id = "home"className="flex flex-col px-7 mt-10 gap-2 mb-14 font-openSans sm:flex sm:flex-row-reverse sm:px-4">
            ...
            <div className="flex flex-col gap-4">
                ...
                <a href="#" className="bg-preto p-5 border border-solid border-marrom w-3/5 font-openSans text-branco2 text-sm ml-auto mr-auto text-center sm:w-4/5">Agende Conosco</a>
